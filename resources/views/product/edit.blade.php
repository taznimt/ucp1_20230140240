            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('product.update', $product->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" value="{{ old('name', $product->name) }}" class="w-full rounded border-gray-300">
                    </div>

                    <div class="mb-4">
                        <label class="block mb-1 text-gray-700 dark:text-gray-200">Qty</label>
                        <input type="number" name="qty" value="{{ old('qty', $product->qty) }}" class="w-full rounded border-gray-300">
                    </div>

                    <div class="mb-4">
                        <label class="block mb-1 text-gray-700 dark:text-gray-200">Price</label>
                        <input type="number" step="0.01" name="price" value="{{ old('price', $product->price) }}" class="w-full rounded border-gray-300">
                    </div>
